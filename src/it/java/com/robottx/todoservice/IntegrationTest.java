...
public abstract class IntegrationTest {
    ...
    protected void assertResponse(ResponseEntity<String> response, String expectedJsonPath) {
        assertResponse(response, expectedJsonPath, HttpStatus.OK);
    }

    protected void assertResponse(ResponseEntity<String> response, String expectedJsonPath, HttpStatus expectedStatus) {
        assertNotNull(response);
        assertEquals(expectedStatus, response.getStatusCode());
        assertJson(response.getBody(), expectedJsonPath);
    }

    protected void assertJson(String actualJson, String expectedJsonPath) {
